  ...
  <div class="allcon">
    <el-container class="sallcon">
      <el-aside class="asidel" style="width: 20%;height: 100%;position: absolute;" >
        <AsideCon :user_name="user_name" :user_id="user_id" :user_dep="user_dep"></AsideCon>
      </el-aside>
...
<script>
  import AsideCon from './AsideCon.vue'
    ...
    components: {
      ...
      data() {
        return {
          ...
          user_dep:this.$route.query.dep_id
        };
      }
...
.allcon{
  ...
  height: 100%;
  width:100%;
  background: url("../../../assets/images/frontbackgr.jpg");
  background-size: cover;
  position: absolute;
}
.asidel {
  background-color: rgba(28, 92, 170, 0.3);
}
.ssallcon{
  height: 100%;
  width: 80%;
...
.head {
  background-color: rgba(114, 169, 224, 0.3);
