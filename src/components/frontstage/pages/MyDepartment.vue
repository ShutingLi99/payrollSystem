  ...
  <div class="allatt">
    ...
    <div class="table">
      ...
      >
        ...
        <el-table-column prop="phone_num" label="电话号码" ></el-table-column>
      </el-table>
  ...
  export default {
    ...
    methods:{
      ...
      getEmp:function(){
        ...
        this.departmentInfo=[];
        this.postInfo=[];
        axios.post('/api/getDepEmp',{dep_id:this.$route.query.dep_id}).then(response=>{
        ...
        axios.get('/api/getDj').then(response=>{
          ...
          // 数据分类
          for (var i = 0; i < len; i++) {
            if(data[i].dep_id==this.$route.query.dep_id){
            this.postInfo.push({
                job_name:data[i].job_name,
