  ...
  <div class="allatt">
    ...
    <div class="table">
      ...
      >
        ...
        <el-table-column prop="all_time" label="日期" ></el-table-column>
        ...
        <el-table-column prop="all_total" label="津贴金额" ></el-table-column>
        <el-table-column prop="o_name" label="津贴类型" ></el-table-column>
        <el-table-column prop="o_rules" label="津贴规则" ></el-table-column>
      </el-table>
  ...
  export default {
    ...
    methods:{
      ...
      getEmp:function(){
        ...
        this.departmentInfo=[];
        this.postInfo=[];
        axios.get('/api/getAllow').then(response=>{
          ...
          for (var i = 0; i < len; i++) {
            ...
            if(data[i].emp_id!=100001){
            this.allStaffInfo.push({emp_id:data[i].emp_id,
              emp_name:data[i].emp_name,
              dep_name:data[i].dep_name,
              job_name:data[i].job_name,
              all_time:data[i].all_time,
              o_rules:data[i].o_rules,
              o_name:data[i].o_name,
              all_total:data[i].all_total,
            });
            }
          }
        });
