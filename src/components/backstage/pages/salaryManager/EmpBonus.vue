  ...
  <div class="allatt">
    ...
    <div class="table">
      ...
      >
        ...
        <el-table-column prop="b_time" label="年份" ></el-table-column>
        ...
        <el-table-column prop="b_total" label="当前奖金总额" ></el-table-column>
      </el-table>
  ...
  export default {
    ...
    methods:{
      ...
      getEmp:function(){
        ...
        this.postInfo=[];
        let byear=new Date();
        var boyear=byear.getFullYear()+'%';
        axios.post('/api/getBonus',{
          postyear:boyear,
          postyearr:boyear
        }).then(response=>{
          ...
          for (var i = 1; i < len; i++) {
            ...
            this.allStaffInfo.push({emp_id:data[i].emp_id,
              ...
              b_time:byear.getFullYear(),
              b_total:data[i].b_total,
            });
          }
        });
