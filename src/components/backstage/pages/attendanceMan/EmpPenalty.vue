  ...
  <div class="allatt">
    ...
    <div class="table">
      ...
      >
        ...
        <el-table-column prop="f_time" label="日期" ></el-table-column>
        ...
        <el-table-column prop="f_name" label="罚款原因" ></el-table-column>
        <el-table-column prop="f_total" label="罚款金额/元" ></el-table-column>
        <el-table-column prop="f_rule" label="罚款规则" ></el-table-column>
      </el-table>
  ...
  export default {
    ...
    methods:{
      ...
      getEmp:function(){
        ...
        this.departmentInfo=[];
        this.postInfo=[];
        axios.get('/api/getFine').then(response=>{
